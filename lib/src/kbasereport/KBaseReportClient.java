...
public class KBaseReportClient {
     ...
     * validity.
     */
    public KBaseReportClient(AuthToken token) throws UnauthorizedException, IOException {
     ...
     * credentials.
     */
    public KBaseReportClient(String user, String password) throws UnauthorizedException, IOException {
